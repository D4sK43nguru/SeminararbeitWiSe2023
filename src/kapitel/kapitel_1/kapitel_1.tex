...
\acp{zta} haben in den letzten Jahren an Bedeutung gewonnen, da traditionelle Sicherheitsansätze immer ineffektiver gegen moderne Cyberbedrohungen werden.
...
Im Jahr $2008$ wurde die dritte Version des \ac{osstmm} veröffentlicht, welche in einem ganzen Kapitel über die Schwachstelle \enquote{Vertrauen} in Systemen befasst.\autocite[\vglf][]{osstmm-2010}
...
\begin{itemize}
    ...
    \item Zugriff auf Ressourcen wird durch dynamische Regelungen festgelegt und kann von verschiedenen Attributen, wie die Identität des \glsdisp{csm}{Clients} beeinflusst werden,

...
Jedoch können die \glsdisp{authentifizierung}{Authentifizierungsanforderungen} an die Nutzer auch deutlich komplexer gestaltet werden, wie \zb mit \ac{mfa}-Anforderungen, oder \glspl{captcha}.

...
\begin{itemize}
    ...
    Alle Daten müssen mit \gls{respekt}, \gls{vertraulichkeit}, \glsdisp{integritaet}{Integrität} und \glsdisp{authentifizierung}{Quellenauthentifizierung} übertragen werden.

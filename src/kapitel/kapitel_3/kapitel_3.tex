...
Es gibt verschiedene Methoden, eine \gls{zta} einzurichten, von denen viele das Konzept teilen, die Kontrolle nahe an den Anwendungen und Nutzern zu halten, anstatt sie in der Netzwerkinfrastruktur auszulagern.\autocite[\vglf][\pagef 4]{buck-2021}
Drei der Grundmethoden einer \gls{zta} sind \glsdisp{authentizitaet}{Anwendungsauthentifizierung}, \glsdisp{authentizitaet}{Gerätauthentifizierung} und Vertrauen, da eine \gls{zta} im Gegensatz zu anderen Sicherheitsinfrastrukturen die \gls{authentizitaet} regelmäßig überprüft, die Nutzergeräte überprüft und Widersprüchlichkeiten in Anwendungen der Nutzer überwacht und erkennt.\autocite[\vglf][\pagef 3]{dsilvia-2021}
...
Eine solche Evaluation kann aus den folgenden, von Horne und Nair\autocite[\vglf][\pagef 3]{horne-2021} dargestellten, Schritten bestehen:
\begin{itemize}
...
\end{itemize}
Horne und Nair stellen weiter dar, wie die einzelnen Schritte einer Überprüfung ablaufen.\autocite[\vglf][\pagef 3]{horne-2021}
\begin{enumerate}
...
Zudem ist eine \gls{zta} flexibler, was die Nutzung von Anwendungen und Geräten betrifft, da die Sicherheitsarchitektur sich nicht auf einzelne Perimeter verlassen muss.\autocites[\vglf][\pagef 28]{shore-2021}[\vglf][]{hunter-2020}
Gleichermaßen stellt eine \gls{zta} eine bessere Einsicht in den Netzverkehr und das Nutzerverhalten dar, was es erneut vereinfacht, Risiken zu erkennen und auf diese zu reagieren.\autocite[\vglf][\pagef 28]{shore-2021}
...
So kann sich das Einrichten einer \gls{zta} durch das Erwerben neuer, notwendiger Werkzeuge und Technologien als teuer darstellen.\autocite[\vglf][\pagef 33]{shore-2021}
...
Darüber hinaus kann die Implementierung einer \gls{zta} komplex und zeitaufwendig sein, sowie signifikante Änderungen in bestehenden Netzwerkinfrastrukturen und Sicherheitsmaßnahmen erfordern.\autocites[\vglf][\pagef 33]{shore-2021}[\vglf][\pagef 11]{buck-2021}
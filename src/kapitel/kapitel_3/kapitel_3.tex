...
Darüber hinaus kann die Implementierung einer \ac{zta} komplex und zeitaufwendig sein, sowie signifikante Änderungen in bestehenden Netzwerkinfrastrukturen und Sicherheitsmaßnahmen erfordern.\autocite[\vglf][\pagef 33]{shore-2021}
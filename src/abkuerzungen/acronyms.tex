...
[CAPTCHA]
    ...
    \acro{captcha}[\gls{captcha}]{Completely Automated Public Turing test to tell Computers and Humans Apart}
    ...
    \acro{nccoe}[NCCoE]{National Cybersecurity Center of Excellence}
    \acro{ncsc}[NCSC]{National Cyber Security Centre}
    ...
    \acro{osstmm}[OSSTMM]{Open Source Security Testing Methodology Manual}
